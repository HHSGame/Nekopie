...
@onready var story_label: Label = $MarginContainer/RootVBox/StoryLabel
@onready var progress_label: Label = $MarginContainer/RootVBox/HeaderRow/ProgressLabel
@onready var enemy_name_label: Label = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyNameLabel
@onready var enemy_hp_label: Label = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyHpLabel
@onready var enemy_hp_bar: ProgressBar = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyHpBar
@onready var enemy_block_label: Label = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyBlockLabel
@onready var enemy_intent_swatch: ColorRect = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyIntentSwatch
@onready var enemy_intent_icon: TextureRect = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyIntentRow/EnemyIntentIcon
@onready var enemy_intent_label: Label = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyIntentRow/EnemyIntentLabel
@onready var enemy_desc_label: Label = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyInfo/EnemyDescLabel
@onready var player_portrait: TextureRect = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerPortraitPanel/PlayerPortrait
@onready var enemy_portrait: TextureRect = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyPortraitPanel/EnemyPortrait
@onready var player_hit_flash: ColorRect = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerPortraitPanel/PlayerHitFlash
@onready var player_hit_fx: TextureRect = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerPortraitPanel/PlayerFxCenter/PlayerHitFx
@onready var enemy_hit_flash: ColorRect = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyPortraitPanel/EnemyHitFlash
@onready var enemy_hit_fx: TextureRect = $MarginContainer/RootVBox/BattleArea/EnemyRow/EnemyPortraitPanel/EnemyFxCenter/EnemyHitFx
@onready var player_hp_label: Label = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerInfo/PlayerPanel/PlayerHpLabel
@onready var player_block_label: Label = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerInfo/PlayerPanel/PlayerBlockLabel
@onready var energy_label: Label = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerInfo/PlayerPanel/EnergyLabel
@onready var draw_label: Label = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerInfo/PlayerPanel/DrawLabel
@onready var discard_label: Label = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerInfo/PlayerPanel/DiscardLabel
@onready var player_hp_bar: ProgressBar = $MarginContainer/RootVBox/BattleArea/PlayerRow/PlayerInfo/PlayerHpBar
@onready var result_label: Label = $HandDock/HandMargin/HandVBox/ResultLabel
@onready var hand_container: HBoxContainer = $HandDock/HandMargin/HandVBox/HandScroll/HandContainer
@onready var end_turn_button: Button = $HandDock/HandMargin/HandVBox/Actions/EndTurnButton
@onready var next_button: Button = $HandDock/HandMargin/HandVBox/Actions/NextButton
@onready var back_button: Button = $MarginContainer/RootVBox/HeaderRow/BackButton
